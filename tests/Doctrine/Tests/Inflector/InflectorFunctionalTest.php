...
class InflectorFunctionalTest extends TestCase
{
    ...
    public function testCustomPluralRule() : void
    {
        ...
        self::assertEquals($inflector->pluralize('custom'), 'customizables');
    }
    ...
    public function testCustomPluralRuleUninflected() : void
    {
        ...
        self::assertEquals($inflector->pluralize('uninflectable'), 'uninflectable');
    }
    ...
    public function testCustomPluralRules() : void
    {
        ...
        self::assertEquals($inflector->pluralize('noflect'), 'noflect');
        self::assertEquals($inflector->pluralize('abtuse'), 'abtuse');
        self::assertEquals($inflector->pluralize('alert'), 'alertables');
        self::assertEquals($inflector->pluralize('amaze'), 'amazable');
        self::assertEquals($inflector->pluralize('phone'), 'phonezes');
    }
    ...
    public function testCustomSingularRule() : void
    {
        ...
        self::assertEquals($inflector->singularize('epler'), 'eple');
        self::assertEquals($inflector->singularize('jenter'), 'jente');
    }
    ...
    public function testCustomSingularRules() : void
    {
        ...
        self::assertEquals($inflector->singularize('inflectors'), 'inflecta');
        self::assertEquals($inflector->singularize('contributors'), 'contributa');
        self::assertEquals($inflector->singularize('spins'), 'spinor');
        self::assertEquals($inflector->singularize('singulars'), 'singulars');
    }
    ...
    public function testUcwords() : void
    {
        self::assertSame(
            ...
            $this->createInflector()->ucwords('top-o-the-morning to all_of_you!')
        );
    }
    ...
    public function testUcwordsWithCustomDelimiters() : void
    {
        self::assertSame(
            'Top-O-The-Morning To All_Of_You!',
            $this->createInflector()->ucwords('top-o-the-morning to all_of_you!', '-_ ')
        );
    }
